...
def getPromptTemplate():
    ...
    DATA:
        Dataset A) Sentiment Indices
            ...
            Dataset Contents: 
            - Timestamp (in column ‘ds’) is the datetime in string formatted like ‘Dec 08 2023 14:00’.  
            ...
            Dataset in CSV format: {historical_sentiment_data}
        ...
        Dataset B) Historical Bitcoin Data
            ...
            Dataset in CSV format: {historical_bitcoin_data}
        ...
        Dataset C) Prediction Bitcoin Data
            ...
            Dataset in CSV format: {prediction_bitcoin_data}
